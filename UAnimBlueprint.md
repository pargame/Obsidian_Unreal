> **캐릭터 애니메이션의 '뇌'이자 '중앙 제어 시스템'입니다.** 캐릭터의 현재 상태(속도, 공중 여부 등)에 따라 어떤 애니메이션 데이터를 어떻게 조합하여 최종 포즈를 만들어낼지를 결정하는 모든 로직이 담겨있는, 매우 강력한 비주얼 스크립팅 에셋입니다.
...
* **`UAnimBlueprint` (설계도):**
      개발자가 에디터에서 편집하는 **에셋**입니다. 애니메이션 로직의 '설계도'라고 할 수 있습니다.
